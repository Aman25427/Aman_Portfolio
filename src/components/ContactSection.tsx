  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await emailjs.sendForm(
        'service_mqvqvci',   // your service ID
        'template_54lw6jy',  // your template ID
        formRef.current!,
        'eeNqtOv8qmOWBKAmT'  // your public key
      );
            ...
            <div className="glass-card p-6 sm:p-8 rounded-xl">
              ...
              <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-border">
                ...
                <div className="flex space-x-3 sm:space-x-4">
                  <a
                    href="https://www.linkedin.com/in/aman-singhania-449b44271/"
                    target="_blank"
                  ...
                  <a
                    href="https://www.instagram.com/aman_kumar_singhania?igsh=bGNjeDZyZm5lNWoz"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 sm:w-10 h-9 sm:h-10 glass-card rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
                  >
